...
(function () {
  ...
  function navInnerHtml(opts) {
    return ''
      ...
      + '<li><a href="turkey.html" data-i18n="nav.turkey">Turkey</a></li>'
      + '</ul></li>'
      + '<li class="nav-dropdown-item">'
      ...
      + '<li><a href="planning-turkey.html" data-i18n="nav.turkey">Turkey</a></li>'
      + '</ul></li>'
  ...
  function mobileMenuHtml() {
    return ''
      ...
      + '<a href="turkey.html" data-i18n="mobile.turkey">Turkey</a>'
      + '</div>'
      + '<div class="mobile-nav-group">'
      ...
      + '<a href="planning-turkey.html" data-i18n="mobile.turkey">Turkey</a>'
      + '</div>'
