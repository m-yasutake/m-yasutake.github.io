...
const TRANSLATIONS = {
  en: {
    ...
    'mobile.blog':      '✍️ Blog',
    'mobile.japan':     'Japan',
    'mobile.denmark':   'Denmark',
    'mobile.norway':    'Norway',
    'mobile.turkey':    'Turkey',
    'mobile.gear':      '🎒 Gear',
    ...
    'about.mika.role':   'Cyclist · Photographer · Foodie',
    'about.mika.bio1':   'Born in Canada to Japanese parents, Mika has a heritage that connects her deeply to the first leg of our journey. She handles most of the photography and has an uncanny ability to find the best places to eat in every city and town we pass through.',
    'about.mika.bio2':   'Before this trip, Mika worked in business management. She loves social workplaces and brings that warm energy to every campsite and hostel along the way. She\'s also a huge fan of downhills.',
    'about.mika.pill1':  '🇨🇦 From Canada',
    'about.mika.pill2':  '📷 Photographer',
    'about.mika.pill3':  '🍽️ Food finder',
    'about.tom.role':    'Cyclist · Route Planner · Engineer',
    'about.tom.bio1':    'Born in Norway but raised in Australia, Tom is the mastermind behind all of our route planning and is responsible for the overly optimistic daily distance estimates.',
    'about.tom.bio2':    'A chemical and software engineer by trade, Tom is easily pulled into the computer world — whether that\'s optimising our route or getting lost in GPS rabbit holes. He loves uphills, survives on whatever food is available, and could happily never visit a grocery store again.',
    'about.tom.pill1':   '🇳🇴🇦🇺 Norway / Australia',
    'about.tom.pill2':   '🗺️ Route Planner',
    'about.tom.pill3':   '⬆️ Uphill lover',
    ...
    'japan.loading.routes':      'Loading map data…',
    ...
    'post.back.denmark':         '← Back to Denmark',
  ...
  ja: {
    ...
    'about.mika.role':   'サイクリスト・写真家・グルメ探索家',
    'about.mika.bio1':   'カナダ生まれで日本人の両親を持つミカは、旅の最初の区間に深いつながりを持っています。写真のほとんどを担当し、立ち寄るどの街や村でも最高の飲食店を見つける不思議な能力を持っています。',
    'about.mika.bio2':   'この旅の前、ミカはビジネスマネジメントの仕事をしていました。社交的な職場が好きで、その温かなエネルギーを道中のキャンプ場やホステルにも持ち込んでいます。下り坂も大好きです。',
    'about.mika.pill1':  '🇨🇦 カナダ出身',
    'about.mika.pill2':  '📷 写真家',
    'about.mika.pill3':  '🍽️ グルメ探索家',
    'about.tom.role':    'サイクリスト・ルートプランナー・エンジニア',
    'about.tom.bio1':    'ノルウェー生まれでオーストラリア育ちのトムは、ルート計画の立案者として旅を支えています。過度に楽観的な1日の走行距離の見積もりを作成するのも彼です。',
    'about.tom.bio2':    '化学・ソフトウェアエンジニアのトムは、コンピュータの世界にのめり込みやすい性格です。ルートの最適化からGPSの探求まで夢中になることも。坂道の上りが大好きで、道中は何でも食べ、スーパーへの買い物はできれば避けたいタイプです。',
    'about.tom.pill1':   '🇳🇴🇦🇺 ノルウェー/オーストラリア',
    'about.tom.pill2':   '🗺️ ルートプランナー',
    'about.tom.pill3':   '⬆️ 上り坂好き',
    ...
    'japan.loading.routes':      '地図データを読み込み中…',
  ...
  no: {
    ...
    'mobile.blog':      '✍️ Blogg',
    'mobile.japan':     'Japan',
    'mobile.denmark':   'Danmark',
    'mobile.norway':    'Norge',
    'mobile.turkey':    'Tyrkia',
    'mobile.gear':      '🎒 Utstyr',
    'mobile.admin':     '⚙️ Admin',
    ...
    'about.mika.role':   'Syklist · Fotograf · Matfinner',
    'about.mika.bio1':   'Mika er født i Canada av japanske foreldre og har en tilknytning som forbinder henne dypt med den første etappen av reisen. Hun tar seg av det meste av fotograferingen og har en utrolig evne til å finne de beste spisestedene i alle byer og tettsteder vi passerer.',
    'about.mika.bio2':   'Før denne turen jobbet Mika med forretningsledelse. Hun liker sosiale arbeidsmiljøer og bringer den varme energien med seg til alle campingplasser og hosteler underveis. Hun er også stor fan av utforbakkene.',
    'about.mika.pill1':  '🇨🇦 Fra Canada',
    'about.mika.pill2':  '📷 Fotograf',
    'about.mika.pill3':  '🍽️ Matfinner',
    'about.tom.role':    'Syklist · Ruteplanlegger · Ingeniør',
    'about.tom.bio1':    'Tom er født i Norge, men vokste opp i Australia, og er hjernen bak all ruteplanlegging. Han er ansvarlig for de altfor optimistiske daglige distanseestimatene.',
    'about.tom.bio2':    'Tom er kjemi- og programvareingeniør og lar seg lett suge inn i dataverdenen — enten det er ruteoptimalisering eller dykk ned i GPS-kaninhull. Han elsker motbakker, spiser hva som helst på veien, og kunne godt levd uten å sette foten i en matbutikk.',
    'about.tom.pill1':   '🇳🇴🇦🇺 Norge / Australia',
    'about.tom.pill2':   '🗺️ Ruteplanlegger',
    'about.tom.pill3':   '⬆️ Motbakkefan',
    ...
    'japan.loading.routes':      'Laster kartdata…',
    ...
    'post.back.denmark':         '← Tilbake til Danmark',
